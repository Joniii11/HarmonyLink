...
[harmonylink](../globals.md) / HarmonyLink
...
> **addNode**(`node`): `Promise`\<[`Node`](Node.md) \| [`Node`](Node.md)[]\>

Adds a node to the node manager.

#### Parameters

• **node**: [`NodeGroup`](../interfaces/NodeGroup.md) \| [`NodeGroup`](../interfaces/NodeGroup.md)[]

The node to add.

#### Returns

`Promise`\<[`Node`](Node.md) \| [`Node`](Node.md)[]\>

The added node.

#### Defined in

src/HarmonyLink.ts:119

***

### createPlayer()

> **createPlayer**(`playerOptions`, `node`?): `Promise`\<[`Player`](Player.md)\>
...
src/HarmonyLink.ts:101

***

### destroyPlayer()

> **destroyPlayer**(`guildId`): `Promise`\<`null` \| [`Player`](Player.md)\>
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](HarmonyLink.md#defaultmaxlisteners).
...
> **removeNode**(`nodeName`): `Promise`\<`null` \| [`Node`](Node.md)\>
...
`Promise`\<`null` \| [`Node`](Node.md)\>

The removed node.

#### Defined in

src/HarmonyLink.ts:135
